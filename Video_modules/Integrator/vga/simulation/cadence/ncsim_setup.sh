...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/vga_video_pll_0_video_pll.vo"                -work video_pll              -cdslib ./cds_libs/video_pll.cds.lib             
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/vga_video_vga_controller_0.v"                -work video_vga_controller_0 -cdslib ./cds_libs/video_vga_controller_0.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/vga_video_rgb_resampler_1.v"                 -work video_rgb_resampler_1  -cdslib ./cds_libs/video_rgb_resampler_1.cds.lib 
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/vga_video_rgb_resampler_0.v"                 -work video_rgb_resampler_0  -cdslib ./cds_libs/video_rgb_resampler_0.cds.lib 
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/vga_video_pll_0.v"                           -work video_pll_0            -cdslib ./cds_libs/video_pll_0.cds.lib           
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/vga_face.sv"                                 -work vga_face_0             -cdslib ./cds_libs/vga_face_0.cds.lib            
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/vga.v"                                                                                                                                
fi
