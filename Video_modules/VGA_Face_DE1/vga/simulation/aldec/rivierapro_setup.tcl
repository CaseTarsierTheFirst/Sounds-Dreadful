...
# ACDS 20.1 711 win32 2024.09.08.04:26:23
# ----------------------------------------
...
# ----------------------------------------
# If vga is one of several IP cores in your
...
ensure_lib                        ./libraries/vga_face_0            
vmap       vga_face_0             ./libraries/vga_face_0            
...
alias com {
  ...
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_up_altpll.v"                          -work video_pll             
  ...
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/vga_video_vga_controller_0.v"                -work video_vga_controller_0
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/vga_video_rgb_resampler_1.v"                 -work video_rgb_resampler_1 
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/vga_video_rgb_resampler_0.v"                 -work video_rgb_resampler_0 
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/vga_video_pll_0.v"                           -work video_pll_0           
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/vga_face.sv"                                 -work vga_face_0            
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/vga.v"                                                                              
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim +access +r -t ps $ELAB_OPTIONS -L work -L reset_from_locked -L video_pll -L rst_controller -L video_vga_controller_0 -L video_rgb_resampler_1 -L video_rgb_resampler_0 -L video_pll_0 -L vga_face_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -dbg -O2 +access +r -t ps $ELAB_OPTIONS -L work -L reset_from_locked -L video_pll -L rst_controller -L video_vga_controller_0 -L video_rgb_resampler_1 -L video_rgb_resampler_0 -L video_pll_0 -L vga_face_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver $TOP_LEVEL_NAME
}
