...
# ----------------------------------------
# ACDS 20.1 711 win32 2025.10.09.12:50:30
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L reset_from_locked -L video_pll -L rst_controller -L video_vga_controller_0 -L video_pll_0 -L vga_face_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -voptargs=+acc -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L reset_from_locked -L video_pll -L rst_controller -L video_vga_controller_0 -L video_pll_0 -L vga_face_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver $TOP_LEVEL_NAME
}
